...
.INCLUDE "src/asm/entities/jankensCastle/sprites.asm"
...
nullSpriteDescriptor_DATA_80E1_:
...
.INCLUDE "src/asm/entities/monsterBirdLeft/sprites.asm"
.INCLUDE "src/asm/entities/monsterBirdRight/sprites.asm"
...
.INCLUDE "src/asm/entities/moneyBag/sprites.asm"
...
.INCLUDE "src/asm/entities/arrow/sprites.asm"
...
.INCLUDE "src/asm/entities/smallFishLeft/sprites.asm"
...
.INCLUDE "src/asm/entities/powerBracelet/sprites.asm"

; Data from 8C2A to 8C2A (1 bytes)
.INCLUDE "src/asm/entities/ghost/spritesLeft.asm"

; Data from 8C4B to 8C4B (1 bytes)
.INCLUDE "src/asm/entities/smallFishRight/sprites.asm"

; Data from 8C6C to 8C6C (1 bytes)
.INCLUDE "src/asm/entities/ghost/spritesRight.asm"
