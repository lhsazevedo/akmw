...
_DATA_B74F_:
.db $01 ENTITY_SCORPION_LEFT $90 $B0 $00

; 3rd entry of Pointer Table from B53F (indexed by v_entityIndex)
; Data from B754 to B75C (9 bytes)
_DATA_B754_:
.db $02 ENTITY_SCORPION_LEFT $90 $70 $00 ENTITY_SCORPION_LEFT $90 $D0 $00
...
_DATA_B777_:
.db $01 ENTITY_SCORPION_LEFT $90 $60 $00

; 7th entry of Pointer Table from B53F (indexed by v_entityIndex)
; Data from B77C to B784 (9 bytes)
_DATA_B77C_:
.db $02 ENTITY_SCORPION_LEFT $90 $40 $00 ENTITY_SCORPION_LEFT $90 $80 $00
...
_DATA_B79F_:
.db $03 ENTITY_SCORPION_LEFT $90 $40 $00 ENTITY_SCORPION_LEFT $90 $70 $00 ENTITY_MONSTER_FROG $90 $C0 $00

; 11th entry of Pointer Table from B53F (indexed by v_entityIndex)
; Data from B7AC to B7B4 (9 bytes)
_DATA_B7AC_:
.db $02 ENTITY_SCORPION_LEFT $90 $70 $00 ENTITY_SCORPION_LEFT $90 $C0 $00
...
_DATA_B7BE_:
.db $02 ENTITY_SCORPION_LEFT $90 $50 $00 ENTITY_MONSTER_FROG $90 $A0 $00
...
_DATA_B7DD_:
.db $02 ENTITY_SCORPION_LEFT $90 $50 $00 ENTITY_MONSTER_FROG $90 $80 $00

; 17th entry of Pointer Table from B53F (indexed by v_entityIndex)
; Data from B7E6 to B7EA (5 bytes)
_DATA_B7E6_:
.db $01 ENTITY_SCORPION_LEFT $90 $80 $00
